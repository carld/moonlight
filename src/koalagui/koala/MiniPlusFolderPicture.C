...
// static
MLImage* MiniPlusFolderPicture::get()
{
...
// static
const int MiniPlusFolderPicture::width= 9;
const int MiniPlusFolderPicture::height= 9;
unsigned char MiniPlusFolderPicture::data[243] =
{
