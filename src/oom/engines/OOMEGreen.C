...
OOMEGreen::OOMEGreen( OOMCanvas* _canvas ):
  OOMEColored( _canvas, 0., 0.4, 0. )
{
  setName("Green");
}
...
void OOMEGreen::write( MLWFileBlock& block )
{
...
void OOMEGreen::read( MLRFileBlock& block )
{
