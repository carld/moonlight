...
OOMERed::OOMERed( OOMCanvas* _canvas ):
  OOMEColored( _canvas, 0.5, 0., 0. )
{
  setName("Red");
}
...
void OOMERed::write( MLWFileBlock& block )
{
...
void OOMERed::read( MLRFileBlock& block )
{
