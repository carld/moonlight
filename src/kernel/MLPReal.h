...
class MLPReal: public MLProperty
{
  friend class MLNode;
...
public:
  MLPReal( MLNode* _node, const char* _name ): MLProperty(_node,_name)
    {
    r= 0.;
    frame= 0;
    }

  MLPReal( MLNode* _node ): MLProperty(_node)
    {
    r= 0.;
    frame= 0;
    }
