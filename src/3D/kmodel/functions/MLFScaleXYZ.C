...
MLFScaleXYZ::MLFScaleXYZ( MLModule* _module ):
  MLBaseFunction(_module)
{}

/////////////////////////////////////////////////////////////////////////////

MLFScaleXYZ::~MLFScaleXYZ()
{}

/////////////////////////////////////////////////////////////////////////////

boolean MLFScaleXYZ::_call()
{
  module->enterMode(ModelModes::DRAG);

  ModelModule* model= (ModelModule*) module;

  model->pushMessage( "Scale: L(X)  M(Y)  R(Z)" );
  ...
  while( ! exitFunction )
    ...
    switch( d->button )
      {
      case 3:  t= Vector(1,1,1+length); break;
      case 2:  t= Vector(1,1+length,1); break;
      case 1:
      default: t= Vector(1+length,1,1); break;
      }
