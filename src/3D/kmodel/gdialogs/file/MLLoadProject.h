...
#ifndef __MLLoadProject_h
#define __MLLoadProject_h
...
class MLLoadProject: public MLGlobalDialog
{
protected:
  ModelModule* model;
...
public:
  MLLoadProject( ModelModule* _model );
  virtual ~MLLoadProject();
...
#endif // ifndef __MLLoadProject_h
