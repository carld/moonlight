...
#ifndef __MLLoadHierarchy_h
#define __MLLoadHierarchy_h
...
class MLLoadHierarchy: public MLGlobalDialog
{
protected:
  ModelModule* model;
...
public:
  MLLoadHierarchy( ModelModule* _model );
  virtual ~MLLoadHierarchy();
...
protected:
  MLObject* load( const MLString& filename );
...
#endif // ifndef __MLLoadHierarchy_h
