...
#ifndef __MLCTagVertex_h
#define __MLCTagVertex_h
...
class MLCTagVertex: public ModelCommand
{
public:
  MLTagVertexArray set;
  MLTagVertexArray unset;

public:
  MLCTagVertex( MLScene* scene );

  virtual ~MLCTagVertex();
