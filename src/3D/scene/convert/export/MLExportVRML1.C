...
MLExportVRML1::MLExportVRML1( MLScene* _scene ):
  MLExport(_scene)
{}

/////////////////////////////////////////////////////////////////////////////

MLExportVRML1::~MLExportVRML1()
{}

/////////////////////////////////////////////////////////////////////////////

boolean MLExportVRML1::run()
{
  if( file == 0 || scene == 0 )
    return false;
  ...
  fprintf( file,
           ...
           "\n"
           "# Scene: \"%s\"\n"
           "# Created with Moonlight Creator %s\n"
           "\n",
...
boolean MLExportVRML1::exportMeshVRML1( MLMesh* mlmesh )
{
  fprintf( file,
           "# Object: %s\n"
           "Separator {\n",
