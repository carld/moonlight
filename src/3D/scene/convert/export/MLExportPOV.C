...
MLExportPOV::MLExportPOV( MLScene* _scene ):
  MLExport(_scene)
{}

/////////////////////////////////////////////////////////////////////////////

MLExportPOV::~MLExportPOV()
{}

/////////////////////////////////////////////////////////////////////////////

boolean MLExportPOV::run()
{
  if( file == 0 || scene == 0 )
    return false;
...
boolean MLExportPOV::exportMeshPOV( MLMesh* m )
{
  if( m == 0 || file == 0 )
    return true;
